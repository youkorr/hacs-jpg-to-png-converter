    ...
    async def convert_jpg_to_png(call: ServiceCall) -> None:
        ...
        try:
            ...
            if resolution != "original" and resolution in RESOLUTIONS:
                ...
                img = img.resize(target_size, Image.Resampling.LANCZOS)  # Restored LANCZOS
            ...
            if optimize_mode == "esp32":
                ...
                img = img.quantize(colors=128, method=2)  # Restored quantization
            ...
            save_options = {
                "format": "PNG",
                "optimize": True,
                "compress_level": 9  # Restored maximum compression
            }
